...
% Find number of collision and velocity after each collision wiht
% user inputs prove conservation of momentum and energy
...
while v(1) > v(2) || v(2) > v(3)
    ...
    if abs(checkEnergy) > cutoff
        checkEnergy
    end
    
    if abs(checkMomentum) > cutoff
        checkMomentum
    end
